...
employees = [
    ...
    Employee(employee_id=10, name="Ryan Cooper", email="ryan.cooper@company.com",password="employee123",credit_card="1234567890123456", department="IT", designation="Senior Developer", role="EMPLOYEE", salary=110000, experience_years=7, manager_id=9, location="San Francisco", performance_rating=4.5, join_date="2017-09-15"),
